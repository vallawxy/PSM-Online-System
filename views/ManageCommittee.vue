<template>
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar" :class="{ 'active' : isActive }"
      ...
      <h1><a href="index.html" class="logo">PSM1</a></h1>
      <ul class="list-unstyled components mb-5">
        <li>

            <router-link to="/adminHome"
          >Lecturer</router-link>
    ...
    <div  align="right">
    <router-link to="/committeeCreate" class="btn btn-success"
      >Create</router-link
    >
  </div>
  </div>
...
import CommList from "../components/CommitteeList.vue";
import "../style.css";
export default {
  name: "manageC",
  components: {
